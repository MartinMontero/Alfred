      ...
      fallback={
        <div class="welcome-screen">
          <div class="welcome-logo">
            {/* F7 (beta.1 smoke): this was the last inline Onyx-rock SVG on a
                user-facing surface — replaced with the Alfred mark. */}
            <img src={AlfredMark} width="96" height="96" alt="The Alfred mark" style={{ 'object-fit': 'contain' }} />
          </div>
          <Show
